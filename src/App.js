    ...
    projects: [
      {
        ...
        description:
          "Farm2Home website delivers farm-fresh, locally sourced produce directly to your doorstep, simplifying your access to quality agricultural products while supporting local farmers.",
      },
      {
        title: "MN-204 | Automated Car System",
        description:
          "Integrating Raspberry Pi with high-definition cameras, live streaming capabilities, and sensor modules empowers users to engage with and explore their environment in real-time.",
      },
      {
        title: "Jayesh | Portfolio Website",
        description:
      ...
      <div className="frame">
        ...
        <div className="body">
          <div className="about">
            ...
            <p>
              Hey! I am Jayesh, 20 Years of age and currently pursuing my B.Tech
              Degree from VIT in IT. I have been since the beginning of my time
              here on earth, fascinated by these machines
              <br />
